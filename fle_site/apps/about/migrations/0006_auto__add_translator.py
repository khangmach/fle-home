...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Translator'
        db.create_table(u'about_translator', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'about', ['Translator'])


    def backwards(self, orm):
        # Deleting model 'Translator'
        db.delete_table(u'about_translator')


    models = {
        u'about.boardmember': {
            'Meta': {'object_name': 'BoardMember', '_ormbases': [u'about.Person']},
            'advisor': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

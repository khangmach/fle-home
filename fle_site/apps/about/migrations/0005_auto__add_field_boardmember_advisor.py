...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BoardMember.advisor'
        db.add_column(u'about_boardmember', 'advisor',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BoardMember.advisor'
        db.delete_column(u'about_boardmember', 'advisor')
